package io.github.bananapuncher714.bondrewd.likes.his.emotes.implementation.v1_18_R1;
		...
		private void transform( NBTTagCompound compound, Function< String, String > transformer ) {
			for ( String key : compound.d() ) {
				...
				if ( base instanceof NBTTagCompound ) {
					...
					compound.a( key, NBTTagString.a( transformer.apply( ( ( NBTTagString ) base ).e_() ) ) );
				}
			}
		}
		...
		private void transform( NBTTagList list, Function< String, String > transformer ) {
			...
			for ( NBTBase base : objects ) {
				if ( base instanceof NBTTagCompound ) {
					...
					String val = ( ( NBTTagString ) base ).e_();
					list.remove( base );
...
//		}
	...
	private class CustomPacketEncoder extends MessageToByteEncoder< Packet< ? > > {
		private EnumProtocolDirection protocolDirection = EnumProtocolDirection.b;
	...
	private class CustomPacketDecoder extends ByteToMessageDecoder {
		private EnumProtocolDirection protocolDirection = EnumProtocolDirection.a;
		private Player player;
		...
		protected void decode( ChannelHandlerContext var0, ByteBuf var1, List< Object > var2 ) throws Exception {
			...
			int var4 = var3.j();
			Packet< ? > var5 = var0.channel().attr( NetworkManager.c ).get().a( this.protocolDirection, var4, var3 );
