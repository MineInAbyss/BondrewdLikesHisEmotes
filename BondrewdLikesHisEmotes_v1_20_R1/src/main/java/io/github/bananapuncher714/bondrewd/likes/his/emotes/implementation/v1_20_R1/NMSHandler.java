package io.github.bananapuncher714.bondrewd.likes.his.emotes.implementation.v1_20_R1;
...
public class NMSHandler implements PacketHandler {
    ...
    public void inject(Player player) {
        ...
        try {
            ...
            manager = (NetworkManager) networkManagerField.get(conn);
        } catch (NoSuchFieldException | IllegalAccessException e) {
            manager = null;
            e.printStackTrace();
        }
        if (manager == null) {
            throw new RuntimeException("NetworkManager is null");
        }
        ...
        private void transform(NBTTagCompound compound, Function<String, String> transformer) {
            for (String key : compound.e()) {
                ...
                if (base instanceof NBTTagCompound) {
                    ...
                    compound.a(key, NBTTagString.a(transformer.apply(((NBTTagString) base).m_())));
                }
            }
        }
        ...
        private void transform(NBTTagList list, Function<String, String> transformer) {
            ...
            for (NBTBase base : objects) {
                if (base instanceof NBTTagCompound) {
                    ...
                    list.add(index, NBTTagString.a(transformer.apply(base.m_())));
                    list.remove(index + 1);
                }
            }
        }
